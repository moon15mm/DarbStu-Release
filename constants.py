...
ROLES = {
    ...
    'health':    {'label': 'موجه صحي',  'tabs': 'most', 'color': '#0d9488'},
...
ROLE_TABS = {
    ...
    'deputy':  ['لوحة المراقبة','المراقبة الحية','روابط الفصول','تسجيل الغياب','تسجيل التأخر',
                ...
                'لوحة الصدارة (النقاط)','إدارة الطلاب','إدارة المعلمين','إدارة الإداريين','إضافة طالب','إدارة الفصول','إدارة الجوالات',
    ...
    # الموجّه الصحي: يرى الغياب والأعذار ليتابع الحالات الصحية، ويستقبل
    # أولياء الأمور. لا يرصد غياباً ولا يرسل رسائل — دوره متابعة لا تسجيل.
    'health':  ['لوحة المراقبة','المراقبة الحية','سجل الغياب','سجل التأخر','الأعذار',
                'تحليل طالب','أكثر الطلاب غياباً','الطلاب المستثنون',
                'التعاميم والنشرات','قصص المدرسة','زيارات أولياء الأمور',
                'تقارير المدرسة','نماذج المعلم'],
