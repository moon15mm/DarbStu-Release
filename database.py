...
def import_students_from_excel_sheet2_format(xlsx_path: str,
    ...
    # ⚠️ المطابقة تامّة لا جزئية — فأي صيغة غير مذكورة هنا تعني «تعذّر
    # اكتشاف بيانات الطلاب». ونور يُخرج ملف مدرسة البنات بصيغة المؤنث
    # («اسم الطالبة»)، فكان الاستيراد يفشل في كل مدارس البنات، ويظهر
    # للمستخدم كأن البرنامج لم يستجب. والهاء بدل التاء المربوطة شائعة
    # في مخرجات نور، و«جوال ولي الأمر» كان غائباً فتُستورد الأرقام
    # فارغةً وتصمت الرسائل كلها.
    STUDENT_ID_COLS  = {"رقم الطالب", "رقم الطالبة", "رقم الطالبه",
                        "رقم الهوية", "رقم الهويه", "الرقم الأكاديمي",
                        "الرقم الاكاديمي", "رقم_الطالب", "السجل المدني",
                        "رقم السجل المدني"}
    STUDENT_NM_COLS  = {"اسم الطالب", "اسم الطالبة", "اسم الطالبه",
                        "الاسم", "الإسم", "اسم_الطالب", "اسم الطالب رباعي",
                        "الاسم الرباعي", "اسم الطالبة رباعي"}
    LEVEL_COLS       = {"رقم الصف", "المرحلة", "المرحله", "الصف",
                        "رقم_الصف", "الصف الدراسي", "المستوى"}
    SECTION_COLS     = {"الفصل", "رقم الفصل", "رقم_الفصل", "الشعبة",
                        "الشعبه", "الفصل الدراسي"}
    PHONE_COLS       = {"رقم الجوال", "الجوال", "جوال", "رقم_الجوال",
                        "phone", "جوال ولي الأمر", "جوال ولي الامر",
                        "رقم ولي الأمر", "رقم ولي الامر", "جوال المشرف",
                        "جوال الأم", "جوال الام"}
